...
//		System.out.println(getHandler().getproperty(application + "Package"));
...
//		}
		...
		if (Stream.of("Android", "ios", "Web", "MPWA", "TV", "HIPI","HIPI_iOS","iOSWeb","ANDROIDMPWA").anyMatch(getPlatform()::equals)) {
