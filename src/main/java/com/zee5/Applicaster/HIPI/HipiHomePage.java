...
//		public static By objMusicButtonBelowLeftSide=By.xpath("//*[@resource-id='com.zee5.hipi:id/text_view_music_title']");
		...
		public static By objMusicButtonBelowLeftSide=By.xpath("//*[contains(@id,'text_view_music_title')] | //*[@resource-id='com.zee5.hipi:id/text_view_music_title']");
		...
		//User Name
		public static By objUserName=By.xpath("//*[@resource-id='com.zee5.hipi:id/text_view_account_handle'] | //*[@resource-id='com.zee5.hipi:id/text_view_account_handle'] | //*[@resource-id='com.zee5.hipi:id/userName']");
		//List of Hashtag
		...
		//-------------------------------------------------
			...
			public static By objShareoptions(int index) {
				...
				public static By objCommentscreenTextField = By.xpath("//*[@id='commentBox'] | //*[@resource-id='com.zee5.hipi:id/commentBox']");
