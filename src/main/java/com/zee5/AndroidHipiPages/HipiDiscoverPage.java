...
public static By objRecentSearch = By.xpath("//*[@id='recent_and_trending_layout']");
	...
	//Search Results - Metadata
		...
		//More Button trending On Hipi
		public static By objMoreButtonProfile = By.xpath("//*[@resource-id='com.zee5.hipi:id/btnMore' and @index='1'] | (//*[@resource-id='com.zee5.hipi:id/btnMore'])[1]");											
...
//		        		By.xpath("//*[@id='btnMore' and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[./*[@contentDescription='ID2circular']]]]");		        //Follow button
		...
		// user tab in Search result page       
				public static By objUsertabinSearchresultpage = By.xpath("//*[@contentDescription='Users'] | //*[@text='Users']");
...
//			first profile
		...
		//------------------------------------muthu--------------------------------------------------------------------------------
				...
				public static By objArrowMarkFirstRailProfile=By.xpath("//*[@resource-id='com.zee5.hipi:id/title']//following::*[@resource-id='com.zee5.hipi:id/btnMore' and @index='1'] | (//*[@resource-id='com.zee5.hipi:id/btnMore'])[1]");
			...
			// first text in boollywood Zone ranbir
		      ...
		      //secondprofile 
		       ...
		       //releated search result
		        ...
		        //profile name
		        public static By objProfileName=By.xpath("(//*[@id='UserRecyclerView']/*/*[@id='userName' and (./preceding-sibling::* | ./following-sibling::*)[@id='userFollowers']])[1] | //*[@resource-id='com.zee5.hipi:id/userName']");
		      //Hashtags 
				...
				public static By objFirstSongSoundTab=By.xpath("(//*[@resource-id='com.zee5.hipi:id/musicName'])[1]");
				 ...
				 public static By objHashtagsButton=By.xpath("//*[@class='android.widget.TextView' and contains(text(),'Hashtags')]");
					...
					public static By objHashhtagsIteratable(int traytitle) {
					 ...
					 public static By objCommentBox=By.xpath("//*[@resource-id='com.zee5.hipi:id/image_view_option_comment']");
...
////////////////////////////////Shakir////////////////////////
								public static By objShopPopup = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgAdd' and @text='Buy now']");
								...
								public static By objPopularSearches = By.xpath("//*[@resource-id='com.zee5.hipi:id/search_header' and contains(@text,'Popular')]");
								public static By objClearTxt = By.xpath("//*[@resource-id='com.zee5.hipi:id/iv_clear_text']");
								public static By objVerifiedUserBadge = By.xpath("//*[@resource-id='com.zee5.hipi:id/user_badge']");
								public static By objDiscoverCTA = By.xpath("//*[@resource-id='com.zee5.hipi:id/shopNowTv' and @text='Discover the look']");
								public static By objShopSubCategories = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtSubCategory' and //*[contains(@text,'Outfit') or contains(@text,'Accessories') or contains(@text,'Beauty') or contains(@text,'Hair')]]");
								public static By shopSubCategories(int index) {
									return By.xpath("(//*[@resource-id='com.zee5.hipi:id/txtSubCategory'])[" + index + "]");
								}
								public static By objProductThumbnail = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgThumbnail']");
								public static By objThirdPartySite = By.xpath("//*[@resource-id='com.zee5.hipi:id/titleUrl']");
								
								public static By wishListHeartCTA = By.xpath("//*[@resource-id='com.zee5.hipi:id/save_card']");
								public static By wishListTab = By.xpath("//*[@resource-id='com.zee5.hipi:id/tabTitleTxt' and @text='WISHLIST']");
								
								public static By wishlistedText = By.xpath("//*[@text='Wishlisted']");
								
								public static By wishListTabCrossIcon = By.xpath("//*[@resource-id='com.zee5.hipi:id/ivDelete']");
								
								public static By wishListProductSite = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtItemSite']");
								
								public static By wishListProuctName = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtItemName']");
								
								public static By objInThisVideoTab = By.xpath("//*[@resource-id='com.zee5.hipi:id/tabTitleTxt' and @text='IN THIS VIDEO']");
								
								public static By objNoSaved = By.xpath("//*[contains(@text,'No saved')]");
								
								public static By objSavedAppear = By.xpath("//*[contains(@text,'Your')]");
								
								public static By objShopIcon = By.xpath("(//*[@resource-id='com.zee5.hipi:id/ivShop'])[1]");
								
								public static By objHipiShopPage = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtHipiShop']");
								
								public static By objShopPageBanner = By.xpath("//*[@resource-id='com.zee5.hipi:id/image']");
								
								public static By objProductCategoriesRail = By.xpath("//*[@text='Dresses ' or @text='Sneakers ' or @text='Topwear ' or @text='Bags ' or @text='Jewellery ' or @text='Beauty ' or @text='Sunglasses ']");
								
								public static By objMoreRightBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/btnMore']");
								
								public static By objShoplistingTitle = By.xpath("//*[@resource-id='com.zee5.hipi:id/textTitle']");
								
								public static By objShopPageWishlistIcon = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgWishlist']");
								
								public static By objDiscoverTheLookCTA = By.xpath("//*[@resource-id='com.zee5.hipi:id/shopNowTv']");
