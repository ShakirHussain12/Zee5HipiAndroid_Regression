...
public class HipiCreateVideoPage {
	...
	// record btn
	public static By objrecordbtn = By.xpath("//*[@id='record_btn'] | //*[contains(@resource-id,'record_btn')]");
	...
	public static By objCreatePermissionVideo = By.xpath("//*[@id='permission_message'] | //*[@resource-id='com.android.permissioncontroller:id/permission_message']");
	public static By objCreateAllow = By.xpath("//*[@id='permission_allow_foreground_only_button' or @id='permission_allow_button'] | //*[@resource-id='com.android.permissioncontroller:id/permission_allow_foreground_only_button'] | //*[@resource-id='com.android.permissioncontroller:id/permission_allow_button']");
...
//==============================================Muthu kumaran M===========================================
		...
		//Speed Button
	public static By objSpeedButton=By.xpath("//*[@id='toggle_image' and (./preceding-sibling::* | ./following-sibling::*)[@text='Speed']]");
		...
		//Flash Button
		public static By objFlashButton=By.xpath("//*[@class='android.widget.LinearLayout' and ./*[@text='Flash'] and ./*[@id='toggle_image']]");
		//Flash Disable Popup
...
//		Trim screen heaader
		...
		public static By objFIlterScreenClearIcon=By.xpath("//*[@id='img_clear']");
				...
				public static By objEditclipscreenRightPlusIcon = By.xpath("//*[@id='addImage_right']");
						...
						public static By objEditClipDurationInfo = By.xpath("//*[@id='trimDurationVal'] | //*[@resource-id='com.zee5.hipi:id/trimEnd']");
						...
						public static By objPhotesTab = By.xpath("//*[contains(@text , 'Photos')]");
						...
						public static By objTrimOptions = By.xpath("//*[contains(@text,'Trim V')]");
