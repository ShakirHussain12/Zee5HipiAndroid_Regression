...
//				   Metadata of reset screen
			  	...
			  	//   Enter 4-digit otp
				   public static By objEnterFourDigitOTP = By.xpath("//*[@resource-id='com.zee5.hipi:id/titleCode' and @text='Enter 4-digit OTP']");
...
//					Metadata of signup  screen
			...
			public static By objProceedCTCHighlighted= By.xpath("//*[@resource-id='com.zee5.hipi:id/btnProceed' and @clickable='true']");
			...
			public static By objVerifyOTPHeader= By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and @text='Verify OTP']");
			   ...
			   public static By objMakeYourOwnVideosSubtitle = By.xpath("//*[@resource-id='com.zee5.hipi:id/subtitle' and contains(@text,'Make your own')]");

			   public static By objCountryCode = By.xpath("(//*[@resource-id='com.zee5.hipi:id/selected_country_tv' and @text='+91'])[2]");
			   
			   public static By objSubtitleSignUpPopup = By.xpath("//*[@resource-id='com.zee5.hipi:id/subtitle' and contains(@text,'Make your own videos')]");
			   
			   //yopmail email input
			   public static By objEmailInput = By.className("ycptinput");
			   ...
			   public static By objDoneGenderHomePage = By.xpath("//*[@text='Done']");
