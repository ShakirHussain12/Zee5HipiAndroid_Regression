...
public class HipiFeedPage {
	...
	public static By objShareSheet = By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and contains(@text,'Share to')]");
	//registerpopup
...
//----------------------------------Kartheek Reddy----------------------------------------------------
			...
			public static By objFollowingTab = By.xpath("//*[@resource-id='com.zee5.hipi:id/rbFollowing']");
			public static By objFollowBtnFollowingTab = By.xpath("//*[@resource-id='com.zee5.hipi:id/followBtn']");
			public static By objSoundDetailsHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/musicTitle']");
			
			public static By objOriginalSound = By.xpath("//*[@resource-id='com.zee5.hipi:id/text_view_music_title']");
			public static By objFollowAnAcc = By.xpath("//*[@resource-id='com.zee5.hipi:id/follow_account']");
			
			//Trending creators header
			public static By objTrendingCreatorsHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvPopulars']");
			
			//Ad CTA
			public static By adCTA = By.xpath("//*[@resource-id='com.zee5.hipi:id/ad_call_to_action']");
			
			public static By objMoreBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and @text='More']/preceding-sibling::*");
