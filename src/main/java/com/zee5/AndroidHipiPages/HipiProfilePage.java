...
//----------------------------------------Kartheek Reddy-----------------------------------------------------
	...
	//---------------------------------Deepa----------------------------------------------------
			...
			public static By objVideoDraftPage =By.xpath("//*[@id='rootLayout' and @class='android.view.ViewGroup']");
...
public static By objRewardsButton = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgRewards']");
public static By objRewardsHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/rewards_text']");
public static By objRewardsBackBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/imgBack']");
public static By objWelcomeTxt = By.xpath("//*[@resource-id='com.zee5.hipi:id/welcome']");
public static By objSubtitleTxt = By.xpath("//*[@resource-id='com.zee5.hipi:id/subtitle']");
public static By objHowToPlayLink = By.xpath("//*[@resource-id='com.zee5.hipi:id/how_to_play']");
public static By objCoinsEarnedOption = By.xpath("//*[@resource-id='com.zee5.hipi:id/coinEarnedLabel']");
public static By objCoinsBalanceOption = By.xpath("//*[@resource-id='com.zee5.hipi:id/coinBalanceLabel']");
public static By objViewMoreVideosTitle = By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and @text='View more videos']");
public static By objThreeLevels = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtLevels']");
public static By objProgramRulesTxt = By.xpath("//*[@resource-id='com.zee5.hipi:id/programRulesText']");
public static By objHowToPlayHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and @text='How to play']");
public static By objCoinsHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/rewards_text' and @text='Coins']");
public static By objClaimNowBtn = By.xpath("//*[@resource-id='com.zee5.hipi:id/txtAmount' and @text='Claim Now']");
