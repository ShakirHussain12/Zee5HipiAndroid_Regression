...
//		Zee5ApplicasterHipiNeoBusinessLogic.verifyUserCanSetPrivacyToDisableLikes_T697(userType);//inva	
	...
	public void  settingAndPrivacyP1TCs(String userType) throws Exception {
		...
		//Privacy related cases are blocked
...
//		
	Zee5ApplicasterHipiNeoBusinessLogic.DataSaverScreenUI_T2496(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyDataSaverOffByDefault_T2497(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyEnabledPostTappingOnRadioButton_T2498(userType);
//		
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageScreenTapingOnContentLanguageOption_T2749(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageSelect_T2751(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageDeSelect_T2752(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageMultiSelect_T2753(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageMultiSelect_T2754(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.networkErrorLanguageSelect_T2755(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.creatorSelectProgramUI_T3227(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.creatorSelectProgramBackNavigation_T3229(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.creatorSelectProgramAgreementNavigation_T3233(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.coinsPageUI_T3302(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.linkPaytmCoins_T3303(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.contentComplaints_T3305(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.contentComplaintsBackNavigation_T3308(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.supportEmailValidation_T3309(userType);
}
...
//		
		...
		Zee5ApplicasterHipiNeoBusinessLogic.discoverPopularSearchesUIForGuest__T3388(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.crossIconSearchTextForGuest__T3389(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.enteredTextDeletedForGuest__T3390(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.originalSoundNameDiscover__T2355_T2356(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSubCategories__T3400_T3408(userType, userType);
		Zee5ApplicasterHipiNeoBusinessLogic.shopSubCategoriesNavigation__T3401_T3409(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListTabUI__T3416(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.noWishlistedProduct__T3421(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopButtonNavigationDiscover__T3431_T3456(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.bannerDetailsBackNavigationDiscover__T3436_T3461(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.productCategroiesRailDiscover__T3437_T3462(userType, userType);
	...
	@Test(priority = 19)
	@Parameters({ "userType"})
	public void loginSignUpP1New(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.phoneEmailBackNavigation_T3301(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.emailPhoneAgeGreatherThan100_T3300(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.emailPhoneAgeLessThan100_T3299(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyOtpScreen_T3297(userType); //P0
		Zee5ApplicasterHipiNeoBusinessLogic.sgnUpUiScreen_T3296(userType); //P1
		Zee5ApplicasterHipiNeoBusinessLogic.mobileNumberSignUpScreen_T3294(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.mobileNumberverifyOtpScreen_T3292(userType); //P0
		Zee5ApplicasterHipiNeoBusinessLogic.signUpUiScreenMobile_T3291(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.invalidOtpScreen_T3285(userType); //P0
		Zee5ApplicasterHipiNeoBusinessLogic.backNavigationLoginSignUp_T3284(userType); //P0
		Zee5ApplicasterHipiNeoBusinessLogic.verifyOtpRegisteredMail_T3281(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.proceedCTAHighlightedLoginSignUp_T3279(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.backNavigationVrifyOtp_T3271(userType); //P0
		Zee5ApplicasterHipiNeoBusinessLogic.phoneEmailUI_T3266(userType); //P0
		
		}

	@Test(priority=20)
	@Parameters({"userType"})
	public void rewardsModuleP1(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsUi_T1965(userType); //P1
			Zee5ApplicasterHipiNeoBusinessLogic.backNavigationRewardsScreen_T1966(userType); //P1
			Zee5ApplicasterHipiNeoBusinessLogic.deviceBackNavigationRewardsScreen_T1967(userType);//P1
				Zee5ApplicasterHipiNeoBusinessLogic.howToPlayLinkRewardsScreen_T1968(userType);// P1
				Zee5ApplicasterHipiNeoBusinessLogic.coinsEarnedCoinsScreen_T1970(userType); //P1
				Zee5ApplicasterHipiNeoBusinessLogic.coinsBalanceCoinsScreen_T1971(userType);//P1
				Zee5ApplicasterHipiNeoBusinessLogic.threeLevelsBannerHowToPlayNavigation_T1975(userType); //P1
				Zee5ApplicasterHipiNeoBusinessLogic.programRulesNavigation_T2001(userType); //P1
				Zee5ApplicasterHipiNeoBusinessLogic.viewMoreVideosRail_T1973(userType); //P2
		}
	
	@Test(priority=21)
	@Parameters({"userType"})
	public void SoundDetailsModuleP1(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3495_T3503(userType, userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3511(userType, userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3516(userType, userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3521(userType, userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3522(userType, userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3532(userType, userType);
	...
	@Test(priority=22)
	@Parameters({"userType"})
	public void rewardsV2ModuleP1(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_1(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T57(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T59(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T62(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T63(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T64(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T65(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T67(userType); DEFECT
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T02(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T04(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T05(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T06(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T07(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T08(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T09(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T10(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T11(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T12(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T15(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T23(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T24(userType);
		
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T25(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T26(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T27(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T28(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.feedAds(userType);
		
	}
	
	@Test(priority=23)
	@Parameters({"userType"})
	public void eCommerce_HipiProductP1(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC2(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC5(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC6(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC7(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC11(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC12(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC13(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC14(userType); DEFECT
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC17(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC18(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC20(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC26(userType); //Toast message tc
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC35(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC36(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC37(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC39(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC40(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC41(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC44(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC45(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC57(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC58(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC59(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC64(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC65(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC66(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC67(userType);
