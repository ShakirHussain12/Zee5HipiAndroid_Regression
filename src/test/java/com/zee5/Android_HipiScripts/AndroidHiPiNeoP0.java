...
//		Zee5ApplicasterHipiNeoBusinessLogic.clickingOnTheMiniPlayer__T364(userType);
//		Zee5ApplicasterHipiNeoBusinessLogic.miniPlayerOnSaveMomentTab__T335(userType);
...
//		Zee5ApplicasterHipiNeoBusinessLogic.checkTheNotificationFormat_T1155(userType);
	...
	public void SettingsPrivacyModulePart2(String userType) throws Exception {
		...
		Zee5ApplicasterHipiNeoBusinessLogic.verifyCELLULARDATAHeaderInSettingPrivacyScreen_T2492(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyDataSaver_T2493(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyTapDataSaver_T2494_T2495(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyTappingBackButton_T2502(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyTappingDeviceBackButton_T2503(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.verifyContentLanguageOption_T2748(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.creatorSelectProgram_T3224(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.creatorSelectProgram_T3226(userType);
		//================================Login==========================================		
		//	//===============================ProfileP0Tcs================================================================
		//
...
//	@Test(priority = 14)			
    ...
    public void DiscoverModuleNew(String userType) throws Exception {
		...
		Zee5ApplicasterHipiNeoBusinessLogic.discoverPopularSearchedForGuest__T3387(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.discoverTheLookCTA__T3398_T3406(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheet__T3399_T3407(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.thirdPartyProductSiteNavigation__T3402_T3410(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.thirdPartyProductSiteNavigationBuyNow__T3403_T3411(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.thirdPartyProductSiteBackNavigationBuyNow__T3412(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.loginSignupPopupWishlistTab__T3405(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListHeartIcon__T3404_3413(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListHeartIconFunctionality__T3414(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListHeartIconFunctionalityProduct__T3415(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListTabProductRemove__T3417(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListedTextNotPresent__T3418(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListThirdPartyNavigation__T3419(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListThirdPartyNavigationBuyNow__T3420(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopButtonDiscover__T3430_T3455(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageBannersDiscover__T3432_T3457(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopListingScreenDiscover__T3440_T3465(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopIconAllVideosShopPageDiscover__T3441_T3466(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.loginPopupWishListIconShopPageDiscover__T3442(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.discoverTheLookShopPageDiscover__T3443_T3467(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetShopPageDiscover__T3444_T3468(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetTwoTabsDiscover__T3445_T3485(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetThirdPartySiteDiscover__T3449_T3469(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishlistHeartIconLoginPopupDiscover__T3450(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.productSubCategoriesDiscover__T3451_T3481(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListFunctionalityShopPageDiscover__T3470(userType, userType);

		Zee5ApplicasterHipiNeoBusinessLogic.wishListTabNavigationShopPageDiscover__T3471(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.wishListedProductShopPageDiscover__T3472(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageWishlistDiscover__T3473(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageWishlistNoSavedProductsDiscover__T3475(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageWishlistUIDiscover__T3476(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageWishlistDiscover__T3477(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopPageWishlistDiscover__T3478(userType, userType);
	...
	@Test(priority = 20)
	@Parameters({"userType"})
	public void RewardsModuleP0(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
	...
	@Test(priority=21)
	@Parameters({"userType"})
	public void loginSignUpP0New(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
	...
	@Test(priority=22)
	@Parameters({"userType"})
	public void SoundDetailsModuleP0(String userType) throws Exception {
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shoppableVideoSoundDetails__T3492_T3501(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3493_T3502(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetProdThumbnailSoundDetails__T3494(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3497_T3504(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3498_T3505(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3499(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3500_T3508(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3507(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3509(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3510(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3512(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3513(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3514(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.shopSheetSoundDetails__T3515(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3520_T3523(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3524(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3526(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3527(userType, userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.soundDetails__T3531(userType, userType);
		
	}
	
	@Test(priority=23)
	@Parameters({"userType"})
	public void rewardsV2ModuleP0(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T55(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T56(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T58(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T60(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_guest_T61(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T15(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.rewardsV2_newUser_T19(userType);
	...
	@Test(priority=24)
	@Parameters({"userType"})
	public void followingModuleNewP0(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2351(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2352_T2353(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2357(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2358(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2362(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2363(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.followingTabNew_T2364(userType);
	}
	
	@Test(priority=25)
	@Parameters({"userType"})
	public void eCommerce_HipiProductP0(String userType) throws Exception{
		Zee5ApplicasterHipiNeoBusinessLogic.relaunch(true);	
		Zee5ApplicasterHipiNeoBusinessLogic.LoginAndNivigateToHipi(userType);
		...
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC21(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC22(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC23(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC24(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC25(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC27(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC28(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC29(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC31(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC32(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC34(userType);
		//Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC38(userType); //toast msg
				
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC42(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC43(userType);
		
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC47(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC48(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC49(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC50(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC51(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC52(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC53(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC54(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC55(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC56(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC60(userType);
		Zee5ApplicasterHipiNeoBusinessLogic.ecommerce_HipiProductDetailPage_TC61(userType);
